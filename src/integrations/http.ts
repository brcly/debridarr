...
export class ConnectionError extends Error {
  ...
  constructor(code: ConnectionCode) {
    super(code);
    this.code = code;
  }
}
...
export async function checkConnection(check: (signal: AbortSignal) => Promise<string>, timeoutMs = CONNECTION_TEST_TIMEOUT_MS): Promise<ConnectionResult> {
